...
class ScriptArgs(U.ExecuteTrainConfig):
    ...
    # GLM-5 DSA indexer go genuinely SPARSE (index_topk=2048).
    ...
    # The GLM-5 DSA indexer (index_topk=2048) only goes SPARSE when prompt+response > 2048;
    ...
    # GLM-5 DSA MoE-LoRA rollout under dp-attention; triton is the robust default.
